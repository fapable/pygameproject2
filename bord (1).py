...
normale_vakjes_omhoog = [(19,2),(18,2),(17,2),(15,2),(14,2),(13,2),(12,2),(11,2),(10,2),(9,2),(8,2),(7,2),(6,2),(4,2),(3,2),(2,0),(1,0),(10,4),(9,7),(8,7),(16,9),(15,12),(4,14),(19,17),(17,17),(13,19),(12,19),(9,22),(7,22),(17,23),(16,23),(14,23),(6,24),(5,24),(13,26),(12,26),(10,26),(9,26),(7,26),(5,26),(18,27),(17,27)]
...
class Player:
    ...
    def update(self):
        if (self.pos.y, self.pos.x) in normale_vakjes_links:
...
def program():
    ...
    Player1 = Player(2,3, obama)
    Player2 = Player(2,0, kim)
    ...
    while not process_events():
        ...
        Player2.draw(screen)
            ...
            # Draw the score text
        #score_text = font.draw("Score: 100", 1, (255, 0, 0))
