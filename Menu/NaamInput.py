...
def name(player: int):
   ...
   y = 0
   if player == 1:
      redSquare = pygame.image.load('foto/player1.png')
   elif player == 2:
      redSquare = pygame.image.load('foto/player2.png')
   elif player == 3:
      redSquare = pygame.image.load('foto/player3.png')
   elif player == 4:
      redSquare = pygame.image.load('foto/player4.png')
   elif player == 5:
      redSquare = pygame.image.load('foto/player5.png')
   elif player == 6:
      redSquare = pygame.image.load('foto/player6.png')
