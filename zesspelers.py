    ...
    def update(self):
        ...
        if beurt == self.name:
            if self.moves >= 4 and (self.pos.y, self.pos.x) in startvakjes:
                ...
                beurt = pl5
                self.turn = False
            elif self.moves == 0 and beurt == pl5 and self.turn == True:
                beurt = pl6
                self.turn = False
            elif self.moves == 0 and beurt == pl6 and self.turn == True:
                beurt = pl1
                self.turn = False
...
def program4():
    ...
    p4 = Player("player4", N.name(), 0, 10, gw, rollobjective1(), rollobjective2(), rollobjective3())
    p5 = Player("player5", N.name(), 0, 11, obama, rollobjective1(), rollobjective2(), rollobjective3())
    p6 = Player("player6", N.name(), 0, 12, snoopdog, rollobjective1(), rollobjective2(), rollobjective3())
